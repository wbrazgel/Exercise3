...
> For days of the weekend, the proportion of casual riders is greater than the proporion of registered riders. On the other hand, on weekdays except for Friday, which isn't measured above, the proportion of registered is greater. This can be explained by regular work commuters during the week compared to recreational fun on the weekends. 
...
[](https://github.com/wbrazgel?tab=repositories)
...
> I took time to examine the vizual but really struggled to understand where to even start. My finished product would not contain much of any of my own work but rather a lot of googling.
